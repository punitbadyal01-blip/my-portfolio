...
export const certificatesData = [
    {
        ...
        issuer: 'Udemy',
        description: 'Comprehensive Java course covering core concepts, OOP principles, collections, generics, streams, multithreading, and modern Java 17+ features.',
        date: '2024',
        icon: '☕',
        image: cert1,
        link: '#',
    },
    {
        ...
        issuer: 'Udemy',
        description: 'Complete Python programming covering fundamentals, data structures, file handling, OOP, libraries like NumPy & Pandas, and automation scripting.',
        date: '2024',
        icon: '🐍',
        image: cert2,
        link: '#',
    },
    {
        ...
        issuer: 'Udemy',
        description: 'In-depth React.js course covering components, hooks, state management, React Router, Redux, and building full-scale modern web applications.',
        date: '2025',
        icon: '⚛️',
        image: cert3,
        link: '#',
    },
    {
        ...
        issuer: 'freeCodeCamp',
        description: 'Mastered JavaScript fundamentals, ES6+ features, functional programming, object-oriented programming, and common algorithms and data structures.',
        date: '2024',
        icon: '⚡',
        image: cert4,
        link: '#',
    },
    {
        ...
        issuer: 'freeCodeCamp',
        description: 'Designed and built responsive websites using modern HTML5 semantics, CSS3, Flexbox, CSS Grid, and accessibility best practices.',
        date: '2024',
        icon: '🌐',
        image: cert5,
        link: '#',
    },
    {
        ...
        issuer: 'Coursera',
        description: 'Applied machine learning techniques including supervised & unsupervised learning, regression, classification, clustering, and model evaluation with scikit-learn.',
        date: '2025',
        icon: '🤖',
        image: cert6,
        link: '#',
    },
    {
        ...
        description: 'Hands-on computer vision course covering image processing, object detection, feature extraction, real-time video analysis, and deep learning integrations.',
        date: '2025',
        icon: '👁️',
        image: cert7,
        link: '#',
    },
    {
        ...
        issuer: 'Udemy',
        description: 'Built RESTful APIs and microservices with Spring Boot, Spring Security, Spring Data JPA, Docker, and deployed full-stack Java applications.',
        date: '2025',
        icon: '🍃',
        image: cert8,
        link: '#',
    },
    {
        ...
        issuer: 'Coursera',
        description: 'Mastered Git workflows, branching strategies, pull requests, merge conflicts, CI/CD pipelines, and best practices for collaborative software development.',
        date: '2024',
        icon: '📦',
        image: cert9,
        link: '#',
    },
    {
        ...
        description: 'Learned Firebase Firestore, Authentication, Cloud Functions, Realtime Database, and Hosting to build and deploy scalable serverless backend applications.',
        date: '2025',
        icon: '🔥',
        image: cert10,
        link: '#',
